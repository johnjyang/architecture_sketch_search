...
def plot_images_architects(query_image_path, similar_images_paths, hq_dir):

    def get_image_architect(image_path):
    ...
    for i in range(plot_count):
        ...
        plt.title(get_image_architect(similar_image_path))
        plt.axis("off")
...
if __name__ == "__main__":
    ...
    for label in labels_list:
        extract_embeddings_and_file_names_from_txt(
            txt_storage_dir=f'''txt_embeddings/txt_embeddings_Resnet50_organized_public_only/{label}''',
            pickle_file_dir=f'''embeddings_data/embeddings_sketches_Resnet50_organized_public_only/embeddings_sketches_Resnet50_public_organized_{label}.pickle''',
